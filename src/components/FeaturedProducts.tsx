...
const products = [
  ...
  { id: 5, name: "Ocean Waves", category: "Japanese", price: 32.99, image: poster5 },
  { id: 6, name: "Autumn Circles", category: "Mid-Century", price: 28.99, image: poster6 },
];
...
const FeaturedProducts = () => {
  ...
  return (
    <section ref={sectionRef} id="shop" className="py-20 md:py-32 bg-secondary overflow-hidden">
