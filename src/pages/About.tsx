...
const values = [
  {
    icon: Leaf,
    title: "Sustainable",
    description: "Eco-friendly materials and responsible printing practices"
  },
  {
    icon: Heart,
...
const team = [
  { name: "Alex Rivera", role: "Founder & Creative Director", image: poster1 },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section ref={heroRef} className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            Somthing started with a simple idea: everyone deserves beautiful art 
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground text-lg">
                <p>
                  It all started in a tiny apartment in 2020. Armed with a passion 
                  for design and a belief that art should be accessible to everyone, 
                  we printed our first poster on a home printer.
                </p>
                <p>
                  Today, Somthing has grown into a global community of art lovers. 
                  We've shipped over 50,000 posters to homes in 25 countries, but 
                  our mission remains the same: to help you express yourself through 
                  beautiful, affordable wall art.
                </p>
                <p>
                  Every poster we create tells a story. And now, they're part of yours.
                </p>
              </div>
            </motion.div>
          </div>
