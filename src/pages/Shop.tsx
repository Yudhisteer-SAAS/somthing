...
import { Heart, ShoppingCart, SlidersHorizontal, Grid3X3, LayoutGrid, X } from "lucide-react";
...
const allProducts = [
  ...
  { id: 7, name: "Forest Whispers", category: "Botanical", price: 31.99, image: poster2 },
  { id: 8, name: "City Lights", category: "Travel", price: 35.99, image: poster3 },
  { id: 9, name: "Minimal Lines", category: "Line Art", price: 22.99, image: poster4 },
  { id: 10, name: "Abstract Fusion", category: "Abstract", price: 38.99, image: poster1 },
  { id: 11, name: "Zen Garden", category: "Botanical", price: 29.99, image: poster2 },
  { id: 12, name: "Mountain Peak", category: "Travel", price: 33.99, image: poster3 },
];
...
const Shop = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState(
    categoryParam ? categories.find(c => c.toLowerCase() === categoryParam) || "All" : "All"
  );
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-secondary to-background relative overflow-hidden">
        <motion.div 
          ...
          style={{
            backgroundImage: "radial-gradient(circle at 20% 80%, hsl(var(--primary) / 0.3) 0%, transparent 50%), radial-gradient(circle at 80% 20%, hsl(var(--accent) / 0.3) 0%, transparent 50%)"
          }}
        />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            ...
            >
              Discover our complete collection of wall art designed to transform any space
            </motion.p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden md:flex items-center gap-1 bg-secondary rounded-lg p-1">
                <button
                  ...
                  className={`p-2 rounded ${gridCols === 2 ? "bg-background shadow-sm" : ""}`}
                >
                  <LayoutGrid className="h-4 w-4" />
                </button>
                <button
                  onClick={() => setGridCols(3)}
                  className={`p-2 rounded ${gridCols === 3 ? "bg-background shadow-sm" : ""}`}
                >
                  ...
                  <Link to={`/product/${product.id}`}>
                    ...
                    >
                      ...
                      <div className="relative aspect-[3/4] overflow-hidden">
                        ...
                        >
                          <Button className="w-full" variant="default" onClick={(e) => e.preventDefault()}>
